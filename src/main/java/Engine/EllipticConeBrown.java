...
public class EllipticConeBrown extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public EllipticConeBrown(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
