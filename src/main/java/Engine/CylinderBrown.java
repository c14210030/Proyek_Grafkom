...
public class CylinderBrown extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public CylinderBrown(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
...
//                vertices.size());
//    }
    public void createCylinderBrown()
    {
        vertices.clear();
