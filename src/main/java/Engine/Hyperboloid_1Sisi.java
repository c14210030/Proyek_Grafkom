...
public class Hyperboloid_1Sisi extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public Hyperboloid_1Sisi(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
