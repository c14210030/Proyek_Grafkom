...
public class Hyperboloid_2Sisi extends Circle{
    float radiusZ;
    int stackCount;
    int sectorCount;
    public Hyperboloid_2Sisi(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, List<Float> centerPoint, Float radiusX, Float radiusY, Float radiusZ,
